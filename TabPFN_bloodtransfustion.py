...
# Get dataset by ID
print("Blood-Transfusion-Service-Center")
...
model_path = output_dir / 'bloodtrans_tabpfn_model.pkl'
...
# Save the plot
plot_path = output_dir / 'bloodtrans_decision_boundary.png'
...
simple_plot_path = output_dir / 'bloodtrans_simple_plot.png'
...
metrics_path = output_dir / 'bloodtrans_metrics.txt'
