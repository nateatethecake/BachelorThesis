...
# Get dataset by ID
print("Hepatitis")
dataset = openml.datasets.get_dataset(55)
print(dataset)
...
model_path = output_dir / 'hepatitis_tabpfn_model.pkl'
...
# Save the plot
plot_path = output_dir / 'hepatitis_decision_boundary.png'
...
simple_plot_path = output_dir / 'hepatitis_simple_plot.png'
...
metrics_path = output_dir / 'hepatitis_metrics.txt'
