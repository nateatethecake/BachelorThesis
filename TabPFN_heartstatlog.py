...
model_path = output_dir / 'heartstat_tabpfn_model.pkl'
...
# Save the plot
plot_path = output_dir / 'heartstat_decision_boundary.png'
...
simple_plot_path = output_dir / 'heartstat_simple_plot.png'
...
metrics_path = output_dir / 'heartstat_metrics.txt'
